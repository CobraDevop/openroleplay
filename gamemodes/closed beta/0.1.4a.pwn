		...
		case DIALOG_DRUG_SELECTION:
		{
			...
			else
	        {
                switch(listitem)
			    {
					...
					case 1:
					{
						if(PlayerData[playerid][Character_Has_Drugs] < 2) return SendPlayerErrorMessage(playerid, " You do not have enough money to completed this course!");
						else
						{
		...
		if(IsPlayerInRangeOfPoint(playerid, 3.0, tx, ty, tz))
		{
			if(DrugActorAmountHeld > 0)
			{
				...
				else
				{
					...
					PlayerData[playerid][Character_Has_Drugs] += 20;
