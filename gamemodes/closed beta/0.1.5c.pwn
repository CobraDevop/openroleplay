		    ...
		    if(response)
		    {
			    ...
			    switch(listitem)
			    {
					case 0:
					{
						...
						SendClientMessage(playerid, COLOR_YELLOW, "Chat:{FFFFFF} /w(hisper) /s(hout) /o(oc) /g(lobal) /clearchat /radio(r) /pm /vipchat");
...
public LoginSpawn(playerid)
{
    ...
    if(PlayerData[playerid][Character_Registered] == 1)
    {
        ...
        else if(PlayerData[playerid][Character_House_ID] > 0 && PlayerData[playerid][Character_Hour] != SERVER_HOUR && PlayerData[playerid][Admin_Jail] == 0)
		{
			...
			SendClientMessage(playerid, COLOR_YELLOW, "Thank you for logging back into the server, you have been spawned at your house! Last Log In: %s", PlayerData[playerid][Character_Last_Login]);
		...
		{			
			...
			SendClientMessage(playerid, COLOR_YELLOW, "Thank you for logging back into the server, you have been spawned at your hotel! Last Log In: %s", PlayerData[playerid][Character_Last_Login]);
		...
		else if(PlayerData[playerid][Character_House_ID] > 0 && PlayerData[playerid][Character_Hour] == SERVER_HOUR && PlayerData[playerid][Admin_Jail] == 0)
		{
		    if(PlayerData[playerid][Character_Pos_X] == 0 && PlayerData[playerid][Character_Pos_Y] == 0 && PlayerData[playerid][Character_Pos_Z] == 0)
			{
				...
				SendClientMessage(playerid, COLOR_YELLOW, "Your account was bugged when saving your last cords. You have been spawned in LS for the time being! Last Log In: %s", PlayerData[playerid][Character_Last_Login]);
			...
			{				
				...
				SendClientMessage(playerid, COLOR_YELLOW, "Thank you for logging back into the server, you have been spawned at your last logout point! Last Log In: %s", PlayerData[playerid][Character_Last_Login]);
...
CMD:checkstats(playerid, params[])
{
	...
	if(PlayerData[playerid][Admin_Level] >= 1)
	{
		...
		else
		{
			...
			{
		        new string1[500], string2[500], string3[500], staffname[50];
				new fstring[20], frankstring[20], jstring[50];
				new factionid;
