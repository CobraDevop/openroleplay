...
public OnGameModeInit()
{
	...
	AddStaticPickup(19198, 1,267.2495,304.6546,999.1484+0.5, -1);
		    ...
		    if(response)
		    {
			    ...
			    switch(listitem)
			    {
					case 0:
					{
						...
						SendClientMessage(playerid, COLOR_WHITE, "General: /jailtime | /acceptdeath | /change | /gps | /cancelgps");
...
public HospitalTimer()
{
 	for(new i; i < MAX_PLAYERS; i ++)
	{
		...
		SendClientMessage(i, COLOR_RED, "[SERVER:] {FFFFFF}Use /change to change your outfits!");
	}
	return 1;
}
...
public LoadHouses_Results()
{
	...
	if(rows)
	{
        ...
        if(HouseData[loaded][House_Outside_X] != 0 && HouseData[loaded][House_Sold] == 1)
      	{
     	    HouseData[loaded][House_Pickup_ID_Outside] = CreateDynamicPickup(1272, 1,HouseData[loaded][House_Outside_X], HouseData[loaded][House_Outside_Y], HouseData[loaded][House_Outside_Z]+0.5, -1);
		}
