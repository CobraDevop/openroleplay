...
public Save_Character_Info_Query_1(playerid)
{
    ...
    mysql_format(connection, playerquery, sizeof(playerquery), "UPDATE `user_accounts` SET \
																...
																`character_house_id` = '%i', `character_total_houses` = '%i', `character_total_businesses` = '%i', \
					...
					, PlayerData[playerid][Character_Total_Businesses], PlayerData[playerid][Character_Level], PlayerData[playerid][Character_Level_Exp]
					, PlayerData[playerid][Character_Name]);
...
public Save_Character_Info_Query_2(playerid)
{
    ...
    mysql_format(connection, playerquery, sizeof(playerquery), "UPDATE `user_accounts` SET \
					...
					, PlayerData[playerid][Character_Has_Drugs], PlayerData[playerid][Character_Has_Food], PlayerData[playerid][Character_Has_Drinks], PlayerData[playerid][Character_Has_Alcohol]
...
public LoadBusinesses_Results()
{
	...
	if(rows)
	{
		...
		if(BusinessData[loaded][Business_Inside_X] != 0)
		{
		    ...
		    CreateDynamicPickup(1274, 1,BusinessData[loaded][Business_BuyPoint_X], BusinessData[loaded][Business_BuyPoint_Y], BusinessData[loaded][Business_BuyPoint_Z]+0.5, loaded);
		}
	}
	return 1;
}
		...
		else
		{
		    switch (value1)
		    {
    			...
    			case 3:
			   {
                    ...
                    CreateDynamicPickup(1274, 1,BusinessData[businessid][Business_BuyPoint_X], BusinessData[businessid][Business_BuyPoint_Y], BusinessData[businessid][Business_BuyPoint_Z]+0.5, businessid);
