	        ...
	        if(strlen(text) != 0)
	        {
				...
				ProxDetector(5.0, playerid, string, -1,-1,-1,-1,-1);
	 			...
	 			format(string, sizeof(string), "* %s puts their phone away in their pocket", GetName(playerid));
			   	...
			   	new dstring[256];
      			format(dstring, sizeof(dstring), "[DISPATCH] We have a new call that needs attention! [/acceptcall (job id)])");
				SendFactionOOCMessage(1, COLOR_ALERTRED, dstring);
				format(dstring, sizeof(dstring), "[DISPATCH] Report ID: %d | Reason: %s", playerid, text);
				SendFactionOOCMessage(1, COLOR_ALERTRED, dstring);
	        ...
	        if(strlen(text) != 0)
	        {
				...
				ProxDetector(5.0, playerid, string, -1,-1,-1,-1,-1);
	 			...
	 			format(string, sizeof(string), "* %s puts their phone away in their pocket", GetName(playerid));
			   	...
			   	new dstring[256];
      			format(dstring, sizeof(dstring), "[DISPATCH] We have a new call that needs attention! [/acceptcall (job id)])");
				SendFactionOOCMessage(2, COLOR_ALERTRED, dstring);
				format(dstring, sizeof(dstring), "[DISPATCH] Report ID: %d | Reason: %s", playerid, text);
				SendFactionOOCMessage(2, COLOR_ALERTRED, dstring);
	        ...
	        if(strlen(text) != 0)
	        {
				...
				ProxDetector(5.0, playerid, string, -1,-1,-1,-1,-1);
	 			...
	 			format(string, sizeof(string), "* %s puts their phone away in their pocket", GetName(playerid));
			   	...
			   	new dstring[256];
      			format(dstring, sizeof(dstring), "[DISPATCH] We have a new call that needs attention! [/acceptcall (job id)])");
				SendFactionOOCMessage(3, COLOR_ALERTRED, dstring);
				format(dstring, sizeof(dstring), "[DISPATCH] Report ID: %d | Reason: %s", playerid, text);
				SendFactionOOCMessage(3, COLOR_ALERTRED, dstring);
...
public OnPlayerStateChange(playerid, newstate, oldstate)
{
	...
	{
	    if(IsLSPDVehicle(veh))
	    {
	        if(PlayerData[playerid][Character_Faction] != 1)
   		    {
	        	RemovePlayerFromVehicle(playerid);
		        SendPlayerErrorMessage(playerid, " You are not within the LSPD Faction, you cannot use this vehicle as a driver!");
	    	}
	    }
	}
    return 1;
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    switch(dialogid)
    {
		...
		case DIALOG_COMMANDS_MAIN:
		{
		    ...
		    if(response)
		    {
			    new titlestring[256], dialogstring[1500], dialogstring1[250], dialogstring2[250], dialogstring3[250], dialogstring4[250], dialogstring5[250], dialogstring6[250], dialogstring7[250], dialogstring8[250];
			    switch(listitem)
			    {
					case 0:
					{
						...
						format(dialogstring2, sizeof(dialogstring2), "\n\n/commands(/cmds) | /guide | /stats | /shop | /call | /endcall | /phonebook | /publicphone");
						format(dialogstring3, sizeof(dialogstring3), "\n/jailtime | /acceptdeath /change");
			        ...
			        case 5:
					{
					    ...
					    else if(PlayerData[playerid][Admin_Level] == 5)
					    {
							...
							format(dialogstring3, sizeof(dialogstring3), "\n\nLevel 3: /setskin | /setarmor");
							format(dialogstring4, sizeof(dialogstring4), "\n\nLevel 4: /factionban | /rfactionban | /weaponban | /rweaponban");
							format(dialogstring5, sizeof(dialogstring5), "\n\nLevel 5: /vcreate | /vpark | /vsetfaction | /vremovefaction | /vsetowner | /vremoveowner | /vdelete | /vinfo\nLevel 5: /fnext | /finfo | /fedit | /fdelete | /givemoney | /givephone");
					    ...
					    else if(PlayerData[playerid][Admin_Level] == 6)
					    {
							...
							format(dialogstring7, sizeof(dialogstring7), "\nLevel 6: /bnext | /binfo | /bedit | /bsetowner | /bremoveowner | /bsetcost | /bsetname | /bdelete | /bsettype\nLevel 6: /globalchat | /jetpack | /givecoins /setlicense /setleader");

							format(dialogstring, sizeof(dialogstring), "%s%s%s%s%s%s%s", dialogstring1, dialogstring2, dialogstring3, dialogstring4, dialogstring5, dialogstring6, dialogstring7, dialogstring8);
							ShowPlayerDialog(playerid, DIALOG_COMMANDS_ADMIN, DIALOG_STYLE_MSGBOX, titlestring, dialogstring, "Close", "");
					    }
					}
			    }
	            ...
	            switch(listitem)
	            {
	                case 0:
	                {
	                    if(PlayerData[targetid][Character_Has_Rope] > 0)
	                    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have just removed ropes from %s!", GetName(targetid));
	                ...
	                case 1:
	                {
	                    if(PlayerData[targetid][Character_Has_Fuelcan] > 0)
	                    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have just removed fuelcans from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
	                ...
	                case 2:
	                {
	                    if(PlayerData[targetid][Character_Has_Lockpick] > 0)
	                    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have just removed lockpicks from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
	                ...
	                case 3:
	                {
	                    if(PlayerData[targetid][Character_Has_Drugs] > 0)
	                    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have just removed drugs from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
	                ...
	                case 4:
	                {
	                    if(PlayerData[targetid][Character_Has_Food] > 0)
	                    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have just removed food from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
	                ...
	                case 5:
	                {
	                    if(PlayerData[targetid][Character_Has_Drinks] > 0)
	                    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have just removed drinks from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
	                ...
	                case 6:
	                {
	                    if(PlayerData[targetid][Character_Has_Alcohol] > 0)
	                    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have just removed alochol from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
	...
	for(new i; i<MAX_PLAYERS; i++)
	{
	    if(IsPlayerLogged[i] == 1)
		{
		    if(PlayerData[i][Character_Registered] == 1)
		    {
		        ...
		        else if(IsPlayerInRangeOfPoint(i, 3.0, 254.4426,76.9794,1003.6406) || IsPlayerInRangeOfPoint(i, 3.0, -1098.1952,1995.3502,-58.9141) || IsPlayerInRangeOfPoint(i, 3.0, -1098.1952,1995.3502,-58.9141))
		        {
		            GameTextForPlayer(i, "/DUTY", 5000, 5); // DUTY LOCATIONS
				}
				else if(IsPlayerInRangeOfPoint(i, 3.0, 254.4943,85.0860,1002.4453))
		        {
...
public DynamicDoorEntry(playerid)
{
	if(IsPlayerConnected(playerid))
	{
	    ...
	    if(IsPlayerNearDynamicDoor(playerid))
	    {
	        ...
	        if(IsPlayerInRangeOfPoint(playerid, 3.0, DoorData[ddoorid][Door_Outside_X], DoorData[ddoorid][Door_Outside_Y], DoorData[ddoorid][Door_Outside_Z]) && DoorData[ddoorid][Door_Faction] > 0 && PlayerData[playerid][Character_Faction] != DoorData[ddoorid][Door_Faction])
	        {
                new tdstring[256];
	        ...
	        else if(IsPlayerInRangeOfPoint(playerid, 3.0, DoorData[ddoorid][Door_Inside_X], DoorData[ddoorid][Door_Inside_Y], DoorData[ddoorid][Door_Inside_Z]) && DoorData[ddoorid][Door_Faction] > 0 && PlayerData[playerid][Character_Faction] != DoorData[ddoorid][Door_Faction])
	        {
                new tdstring[256];
	    		format(tdstring, sizeof(tdstring), "~r~You Cannot Use This Door!");
				PlayerTextDrawSetString(playerid, PlayerText:Notification_Textdraw, tdstring);
	        ...
	        else if(IsPlayerInRangeOfPoint(playerid, 3.0, DoorData[ddoorid][Door_Outside_X], DoorData[ddoorid][Door_Outside_Y], DoorData[ddoorid][Door_Outside_Z]))
			{
		...
		if(IsPlayerInRangeOfPoint(playerid, 3.0, 267.2495,304.6546,999.1484))
     	{
			if(PlayerData[playerid][Character_Hotel_ID] == 1)
   			{
...
stock IsLSPDVehicle(vehicleid)
{
    for(new carid = 1; carid < MAX_VEHICLES; carid++)
    {
        if(carid == VehicleData[vehicleid][Vehicle_ID] && VehicleData[vehicleid][Vehicle_Faction] == 1)
        {
            return 1;
        }
    }
        ...
        if(PlayerData[playerid][Character_Hotel_ID] == 0)
        {
            ...
            if(IsPlayerInRangeOfPoint(playerid, 3.0, 1498.2710,-1581.8063,13.5498))
        	{
        	    if(PlayerData[playerid][Character_Money] >= 250)
        	    {
				    ...
				    format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just rented a room at the Trump Hotel!");
    ...
    else
    {
        if(PlayerData[playerid][Character_Hotel_ID] == 1)
        {
            ...
            if(IsPlayerInRangeOfPoint(playerid, 3.0, 1498.2710,-1581.8063,13.5498))
        	{
			    ...
			    format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just unrented a room at the Trump Hotel and received a $50 deposit back!");
				SendClientMessage(playerid, COLOR_YELLOW, dstring);
	        }
	        else return SendPlayerErrorMessage(playerid, " You are not at a rental property!");
        }
...
CMD:publicphone(playerid, params[])
{
		...
		else
		{
		    ...
		    if(targetid == playerid)
		    {
				if(IsPlayerInRangeOfPoint(playerid, 10.0, px, py, pz))
				{
						...
						format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have just been given a ticket of $%i for '%s' by Officer %s", amount, reason, GetName(playerid));
						SendClientMessage(playerid, COLOR_YELLOW, string);
			...
			if(sscanf(params, "i", targetid))
		 	{
		  	...
		  	else
		  	{
                if(EmergencyCallTypeRequired[targetid] == 1)
                {
					...
					SendClientMessage(targetid, COLOR_ALERTRED, dstring);
					
					format(dstring, sizeof(dstring), "[GPS] We have marked the location of the caller on your map!");
					SendClientMessage(playerid, COLOR_YELLOW, dstring);
					
					
					format(dstring, sizeof(dstring), "[DISPATCH] Officer %s is responding to call id: %d", GetName(playerid), targetid);
					SendFactionOOCMessage(1, COLOR_ALERTRED, dstring);
			...
			if(sscanf(params, "i", targetid))
		 	{
		  	...
		  	else
		  	{
                if(EmergencyCallTypeRequired[targetid] == 2)
                {
					...
					format(dstring, sizeof(dstring), "[DISPATCH] Fireman %s is responding to call id: %d", GetName(playerid), targetid);
					SendFactionOOCMessage(2, COLOR_ALERTRED, dstring);
			...
			if(sscanf(params, "i", targetid))
		 	{
		  	...
		  	else
		  	{
                if(EmergencyCallTypeRequired[targetid] == 3)
                {
					...
					format(dstring, sizeof(dstring), "[DISPATCH] Paramedic %s is responding to call id: %d", GetName(playerid), targetid);
					SendFactionOOCMessage(3, COLOR_ALERTRED, dstring);
	  		    ...
	  		    if(IsPlayerInRangeOfPoint(playerid, 5.0, tx, ty, tz))
	  		    {
					if(license == 1)
					{
					    ...
					    if(status == 1)
					    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Motorcycle License to %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
					    }
					    else
					    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Motorcycle License from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
					    }
					}
					else if(license == 2)
					{
					    ...
					    if(status == 1)
					    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Car License to %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
					    }
					    else
					    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Car License from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
					    }
					}
					else if(license == 3)
					{
					    ...
					    if(status == 1)
					    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Truck License to %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
					    }
					    else
					    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Truck License from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
					    }
					}
					else if(license == 4)
					{
					    ...
					    if(status == 1)
					    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Boat License to %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
					    }
					    else
					    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Boat License from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
					    }
					}
					else if(license == 5)
					...
					else if(license == 6)
					{
					    ...
					    if(status == 1)
					    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Firearms License to %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
					    }
					    else
					    {
							...
							format(string, sizeof(string), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Firearms License from %s!", GetName(targetid));
							SendClientMessage(playerid, COLOR_YELLOW, string);
					    }
					}
				}
...
CMD:duty(playerid, params[])
{
    ...
    else
    {
        if(PlayerData[playerid][Character_Faction] == 1)
        {
				...
				else return SendPlayerErrorMessage(playerid, " You are not near a duty point of the LSPD, LSFD or the LSMC!");
		}
		else if(PlayerData[playerid][Character_Faction] == 2)
        {
		...
		else
  		{
            ...
            if(PlayerData[playerid][Character_Faction_Ban] > 0) return SendPlayerErrorMessage(playerid, " You cannot hire someone who has a faction ban. Please contact staff via forums for removal against player!");
			else
		  	{
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just been hired into faction %s!", factionname);
		...
		if(sscanf(params, "is", targetid, reason))
		{
		...
		else
  		{
			...
			else
		  	{
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just been fired from faction %s!", factionname);
				SendClientMessage(targetid, COLOR_YELLOW, dstring);
		...
		else
  		{
			...
			if(rankid < 1 || rankid > 5) return SendPlayerErrorMessage(playerid, " You need to give a rank level between 1 and 5!");
			else
		  	{
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just been given the new rank of %s!", rankname);
				SendClientMessage(targetid, COLOR_YELLOW, dstring);
...
CMD:quitfaction(playerid, params[])
{
	if(PlayerData[playerid][Character_Registered] != 1) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
	    if(PlayerData[playerid][Character_Faction] == 0) return SendPlayerErrorMessage(playerid, " You cannot quit a faction at this point in time. Reason: You are not apart of any faction!");
		{
		    ...
		    format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just left the %s faction. We are sorry to see you leave!", FactionData[factionid][Faction_Name]);
			SendClientMessage(playerid, COLOR_YELLOW, dstring);
...
CMD:joinfaction(playerid, params[])
{
    ...
    if(PlayerData[playerid][Character_Faction] == 0)
	{
		...
		if(IsPlayerInRangeOfPoint(playerid, 3.0, 257.1519,69.9842,1003.6406)) // LSPD JOIN LOCATION
		{
		    ...
		    format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just applied to join the %s. Please wait to be accepted into the faction. [WARNING: This process can take days!]", FactionData[factionid][Faction_Name]);
			SendClientMessage(playerid, COLOR_YELLOW, dstring);
	...
	if(PlayerData[playerid][Character_Faction_Rank] != 6) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
	    ...
	    if(sscanf(params, "i", targetid))
		{
		...
		else
  		{
		    ...
		    format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just been accepted into faction %s!", FactionData[factionid][Faction_Name]);
			SendClientMessage(targetid, COLOR_YELLOW, dstring);
	...
	if(PlayerData[playerid][Character_Faction_Rank] != 6) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
	    ...
	    if(sscanf(params, "i", targetid))
		{
		...
		else
  		{
		    ...
		    format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have been rejected from joining faction %s!", FactionData[factionid][Faction_Name]);
			SendClientMessage(targetid, COLOR_YELLOW, dstring);
	...
	if(PlayerData[playerid][Character_Registered] != 1) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
		...
		if(bdoorid != 0 && BusinessData[bdoorid][Business_Owner] != PlayerData[playerid][Character_Name])
		{
		...
		else
  		{
			...
			format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just sold your business %s for $%d", BusinessData[bdoorid][Business_Name], BusinessData[bdoorid][Business_Price_Money]);
			SendClientMessage(playerid, COLOR_YELLOW, dstring);
		...
		if(sscanf(params, "i", response))
		{
		...
		else
  		{
			...
			if(response == 1)
			{
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just purchased business %s for $%d", BusinessData[bdoorid][Business_Name], BusinessData[bdoorid][Business_Price_Money]);
				SendClientMessage(playerid, COLOR_YELLOW, dstring);
			...
			else if(response == 2)
			{
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just purchased business %s for %d coins", BusinessData[bdoorid][Business_Name], BusinessData[bdoorid][Business_Price_Coins]);
				SendClientMessage(playerid, COLOR_YELLOW, dstring);
	...
	if(PlayerData[playerid][Character_Registered] != 1) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
		...
		if(hdoorid != 0 && HouseData[hdoorid][House_Owner] != PlayerData[playerid][Character_Name])
		{
		...
		else
  		{
			...
			format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just sold your house %s for $%d", HouseData[hdoorid][House_Address], HouseData[hdoorid][House_Price_Money]);
			SendClientMessage(playerid, COLOR_YELLOW, dstring);
		...
		if(sscanf(params, "i", response))
		{
		...
		else
  		{
			...
			if(response == 1)
			{
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just purchased property %s for $%d", HouseData[hdoorid][House_Address], HouseData[hdoorid][House_Price_Money]);
				SendClientMessage(playerid, COLOR_YELLOW, dstring);
			...
			else if(response == 2)
			{
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just purchased property %s for $%d", HouseData[hdoorid][House_Address], HouseData[hdoorid][House_Price_Coins]);
				SendClientMessage(playerid, COLOR_YELLOW, dstring);
	...
	if(PlayerData[playerid][Admin_Level] >= 2)
	{
		...
		else
		{
		    ...
		    else
		    {
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} If you feel that this temp mute is not justified, please report this action on our forum!");
				SendClientMessage(targetid, COLOR_YELLOW, dstring);
...
CMD:sethealth(playerid, params[])
{
    if(PlayerData[playerid][Admin_Level] >= 3)
	{
		...
		else
		{
		    ...
		    new dstring[256];
			format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} Admin has set your armour amount to: %i!", healthamount);
			SendClientMessage(targetid, COLOR_YELLOW, dstring);
...
CMD:setskin(playerid, params[])
{
    if(PlayerData[playerid][Admin_Level] >= 3)
	{
		...
		else
		{
		    ...
		    new dstring[256];
			format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} Admin has set your skin id to: %i!", skinid);
			SendClientMessage(targetid, COLOR_YELLOW, dstring);
...
CMD:setarmour(playerid, params[])
{
    if(PlayerData[playerid][Admin_Level] >= 3)
	{
		...
		else
		{
		    ...
		    new dstring[256];
			format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} Admin has set your armour amount to: %i!", armouramount);
			SendClientMessage(targetid, COLOR_YELLOW, dstring);
    ...
    if(PlayerData[playerid][Admin_Level] >= 4)
	{
	    ...
	    else
	    {
			...
			else
			{
	    		...
	    		new dstring[256];
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} Admin has just faction banned you! If you feel this is incorrect, please report on forums");
				SendClientMessage(targetid, COLOR_YELLOW, dstring);
    ...
    if(PlayerData[playerid][Admin_Level] >= 4)
	{
	    ...
	    else
	    {
			...
			else
			{
	    		...
	    		new dstring[256];
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An admin has just removed a faction ban from your account!");
				SendClientMessage(targetid, COLOR_YELLOW, dstring);
	    ...
	    else
	    {
			...
			else
			{
				if(license == 1)
				{
				    ...
				    {
                	    new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has given you a Motorcycle License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Motorcycle License to %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
					}
					else
					{
	                    new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has revoked your Motorcycle License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Motorcycle License from %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
				    }
				}
				else if(license == 2)
				{
				    ...
				    {
                	    new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has given you a Car License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Car License to %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
         			}
					else
					{
                    	new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has revoked your Car License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Car License from %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
		    		}
				}
				else if(license == 3)
				{
	    			...
	    			{
     					new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has given you a Truck License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Truck License to %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
	    			}
	    			else
	    			{
     					new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has revoked your Truck License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Truck License from %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
	    			}
				}
				else if(license == 4)
				{
    				...
    				{
    					new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has given you a Boat License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Boat License to %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
    				}
    				else
    				{
    					new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has revoked your Boat License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Boat License from %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
    				}
				}
				else if(license == 5)
				{
    				PlayerData[targetid][Character_License_Flying] = status;
   					...
   					{
   						new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has given you a Flying License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Flying License to %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
   					}
   					else
   					{
   						new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has revoked your Flying License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Flying License from %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
   					}
				}
				else if(license == 6)
				{
   					...
   					{
   						new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has given you a Firearms License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have issued a Firearms License to %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
   					}
   					else
   					{
						new dstring[256];
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has revoked your Firearms License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
						
						format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have revoked a Firearms License from %s", GetName(targetid));
						SendClientMessage(playerid, COLOR_YELLOW, dstring);
					}
				}
			}
    ...
    if(PlayerData[playerid][Admin_Level] >= 6)
	{
	    ...
	    else
	    {
			...
			else
			{
				...
				new dstring[256];
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An Admin has given you leadership of: %s", FactionData[factionid][Faction_Name]);
				SendClientMessage(targetid, COLOR_YELLOW, dstring);

				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have given %s leadership of faction: %s", GetName(targetid), FactionData[factionid][Faction_Name]);
				SendClientMessage(playerid, COLOR_YELLOW, dstring);
			}
	    }
	}
...
CMD:givemoney(playerid, params[])
{
	if(PlayerData[playerid][Admin_Level] >= 5)
	{
	    ...
	    else
	    {
	        ...
	        new dstring[256];
			format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} Admin has given you $%i!", money);
			SendClientMessage(targetid, COLOR_YELLOW, dstring);
...
CMD:givephone(playerid, params[])
{
    if(PlayerData[playerid][Admin_Level] >= 5)
    {
        ...
        else
        {
            ...
            format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} Admin has given you a phone with number (%d)!", SQL_PHONENUMBER_GENERATED);
            SendClientMessage(targetid, COLOR_YELLOW, dstring);

            format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just given %s a phone with number (%d)!", GetName(targetid), SQL_PHONENUMBER_GENERATED);
            SendClientMessage(playerid, COLOR_YELLOW, dstring);
        }
    }
    else
	...
	if(PlayerData[playerid][Admin_Level] < 5) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
		...
		else
		{
			...
			else if(HasPlayerConfirmedVehicleID[playerid] > 0)
			{
				...
				if(strlen(VehicleData[vehicleid][Vehicle_License_Plate]) == 0)
				{
				    new lpstring[10];
...
CMD:givecoins(playerid, params[])
{
	if(PlayerData[playerid][Admin_Level] != 6) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
	    ...
	    else
	    {
	        ...
	        new dstring[256];
			format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} Admin has given you %i coins!", coins);
			SendClientMessage(targetid, COLOR_YELLOW, dstring);
	...
	if(PlayerData[playerid][Admin_Level] != 6) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
		...
		else
		{
		    ...
		    else
		    {
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just been given ownership of property %s", HouseData[houseid][House_Address]);
				SendClientMessage(targetid, COLOR_YELLOW, dstring);
			}
		}
	}
	...
	if(PlayerData[playerid][Admin_Level] != 6) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
		...
		else
		{
		    ...
		    else
		    {
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An admin has just removed you from property: %s", HouseData[houseid][House_Address]);
				SendClientMessage(targetid, COLOR_YELLOW, dstring);
			}
		}
	}
	...
	if(PlayerData[playerid][Admin_Level] != 6) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
		...
		else
		{
		    ...
		    else
		    {
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} You have just been given ownership of business %s", BusinessData[businessid][Business_Name]);
				SendClientMessage(targetid, COLOR_YELLOW, dstring);
			}
		}
	}
	...
	if(PlayerData[playerid][Admin_Level] != 6) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
		...
		else
		{
		    ...
		    else
		    {
				...
				format(dstring, sizeof(dstring), "[CHARACTER UPDATE:]{FFFFFF} An admin has just removed you from business: %s", BusinessData[businessid][Business_Name]);
				SendClientMessage(targetid, COLOR_YELLOW, dstring);
			}
		}
	}
