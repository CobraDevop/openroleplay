...
public SaveUserInformation(playerid)
{
    ...
    mysql_format(connection, playerquery, sizeof(playerquery), "UPDATE `user_accounts` SET `character_age` = '%i', `character_sex` = '%s', `character_birthplace` = '%s', `character_registered` = '%i', `character_skin` = '%i', `character_last_login` = '%i', `character_minutes` = '%i', `character_health` = '%f', `character_armor` = '%f', \
																...
																`character_license_car` = '%i', `character_license_truck` = '%i',`character_license_motorcycle` = '%i',`character_license_boat` = '%i',`character_license_flying` = '%i',`character_license_firearms` = '%i' WHERE `character_name` = '%e' "
				    ...
				    , PlayerData[playerid][Character_Skin] 
