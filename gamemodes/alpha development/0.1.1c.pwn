...
public OnGameModeInit()
{
	...
	SetTimer("ONE_SECOND_TIMER", 1000, 1);
...
public OnPlayerEnterCheckpoint(playerid)
{
	...
	if(MechanicJobPlayer[playerid] == 1)
	{
		...
		{
		    ApplyAnimation(playerid, "BOMBER", "BOM_Plant", 4.0, true, 0, 0, 0, 0);
		    ...
		    if(response)
		    {
			    ...
			    switch(listitem)
			    {
					case 0:
					{
						...
						SendClientMessage(playerid, COLOR_WHITE, "General: /admins | /pockets");
						SendClientMessage(playerid, COLOR_WHITE, "Vehicle: /park | /engine | /lights | /boot | /bonnet | /lock | /recyclecar | /changeownership");
			        ...
			        case 1:
					{
					    ...
					    else if(PlayerData[playerid][Character_Faction] == 1)
					    {
					        if(PlayerData[playerid][Character_Faction_Rank] != 6)
					        {
						        ...
						        SendClientMessage(playerid, COLOR_WHITE, "General: /joinfaction | /quitfaction");
						        ...
						        SendClientMessage(playerid, COLOR_WHITE, "Basic: /acceptcall | /acceptjob | /arrest | /search");
					    ...
					    else if(PlayerData[playerid][Character_Faction] == 2)
					    {
					        if(PlayerData[playerid][Character_Faction_Rank] != 6)
					        {
						        ...
						        SendClientMessage(playerid, COLOR_WHITE, "General: /joinfaction | /quitfaction");
						        SendClientMessage(playerid, COLOR_WHITE, "Chat: factionchat(/fchat) | /fradio(/fr)");
						        SendClientMessage(playerid, COLOR_WHITE, "Basic: /acceptcall | /acceptjob | /duty | /emsbag | /drag | /heal");
					    ...
					    else if(PlayerData[playerid][Character_Faction] == 3)
					    {
					        if(PlayerData[playerid][Character_Faction_Rank] != 6)
					        {
						        ...
						        SendClientMessage(playerid, COLOR_WHITE, "General: /joinfaction | /quitfaction");
						        SendClientMessage(playerid, COLOR_WHITE, "Chat: factionchat(/fchat) | /fradio(/fr)");
						        SendClientMessage(playerid, COLOR_WHITE, "Basic: /acceptcall | /acceptjob | /duty | /ladder | /drag | /fireex");
						        SendClientMessage(playerid, COLOR_WHITE, "Vehicle: /placeincar(/pic) | /cleo");
							}
							else
							{
			        ...
			        case 5:
					{
					    ...
					    else if(PlayerData[playerid][Admin_Level] == 6)
					    {
					        ...
					        SendClientMessage(playerid, COLOR_WHITE, "[6] /globalchat | /jetpack | /givecoins | /setlicense | /setleader | /setadmin | /gmx");
					    }
					}
			    }
			}
...
public OnAccountCheck(playerid)
{
    if(cache_num_rows() > 0)
    {
        ...
        PlayerData[playerid][Character_Interior_ID] = cache_get_field_content_int(0, "character_interior_id");
       	...
       	PlayerData[playerid][Character_Owns_Faction] = cache_get_field_content_int(0, "character_owns_faction");
	    ...
	    PlayerData[playerid][Character_Has_Device] = cache_get_field_content_int(0, "character_has_device");
        ...
        PlayerData[playerid][Hotel_Character_Interior_ID] = cache_get_field_content_int(0, "hotel_character_interior_id");
       	...
       	PlayerData[playerid][Character_Total_Vehicles] = cache_get_field_content_int(0, "character_total_vehicles");
...
public Save_Character_Info_Query_2(playerid)
{
    ...
    mysql_format(connection, playerquery, sizeof(playerquery), "UPDATE `user_accounts` SET \
				    ...
				    , PlayerData[playerid][Character_Radio], PlayerData[playerid][Character_Has_Rope], PlayerData[playerid][Character_Has_Fuelcan], PlayerData[playerid][Character_Has_Lockpick], PlayerData[playerid][Character_Has_Device]
					, PlayerData[playerid][Character_Has_Drugs], PlayerData[playerid][Character_Has_Food], PlayerData[playerid][Character_Has_Drinks], PlayerData[playerid][Character_Has_Alcohol], PlayerData[playerid][Character_Has_Phone], PlayerData[playerid][Character_Phonenumber], PlayerData[playerid][Character_Has_SimCard], PlayerData[playerid][Character_Total_Vehicles], PlayerData[playerid][Character_Name]);
...
public OnBillPay(playerid)
{
    ...
    if (cache_num_rows() > 0)
    {
        billID = cache_get_field_content_int(0, "bill_id");
       	cache_get_field_content(0, "character_name", billCharacterName, sizeof(billCharacterName));
		cache_get_field_content(0, "bill_name", billName, sizeof(billName));
		billAmount = cache_get_field_content_int(0, "bill_amount");
...
public OnReportCloseCheck(playerid)
{
    ...
    if (cache_num_rows() > 0)
    {
        reportID = cache_get_field_content_int(0, "report_id");
...
public OnReportCheck(playerid)
{
    ...
    if (cache_num_rows() > 0)
    {
        ...
        {
           	reportID = cache_get_field_content_int(i, "report_id");
           	cache_get_field_content(i, "character_name", reportName, sizeof(reportName));
           	cache_get_field_content(i, "target_name", reportTarget, sizeof(reportTarget));
           	cache_get_field_content(i, "reason", reportReason, sizeof(reportReason));

			format(string, sizeof(string), "> {F2F746}Report ID:{FFFFFF} %d - {F2F746}Reported Name:{FFFFFF} %s", reportID, reportTarget);
   			SendClientMessage(playerid, COLOR_WHITE, string);
   			format(string, sizeof(string), "> {F2F746}Reason:{FFFFFF} %s", reportReason);
   			SendClientMessage(playerid, COLOR_WHITE, string);
   			format(string, sizeof(string), "-----------------------------------", reportReason);
   			SendClientMessage(playerid, COLOR_WHITE, string);
        }
    }
    else
...
public OnBillCheck(playerid)
{
    ...
    if (cache_num_rows() > 0)
    {
        for (new i = 0; i < cache_num_rows(); i++)
        {
           	billID = cache_get_field_content_int(i, "bill_id");
           	cache_get_field_content(i, "character_name", billCharacterName, sizeof(billCharacterName));
			cache_get_field_content(i, "bill_name", billName, sizeof(billName));
			billAmount = cache_get_field_content_int(i, "bill_amount");
			billType = cache_get_field_content_int(i, "bill_type");
	...
	for(new i; i<MAX_PLAYERS; i++)
	{
	    if(IsPlayerLogged[i] == 1)
		{
		    if(PlayerData[i][Character_Registered] == 1)
		    {
		        ...
		        else if(IsPlayerInRangeOfPoint(i, 3.0, 2164.5356,1600.1710,999.9771))
		        {
				...
				else if(IsPlayerInRangeOfPoint(i, 3.0, 1498.2710,-1581.8063,13.5498))
		        {
		            ...
		            {
		                new tdstring[256];
					    format(tdstring, sizeof(tdstring), "~y~Trump Hotel~n~~n~~w~Tap ~y~Enter_Key~w~ To Use Door!");
		            ...
		            {
		                new tdstring[256];
					    format(tdstring, sizeof(tdstring), "~y~Trump Hotel~n~~n~~y~$250 ~w~for a room~n~~n~~y~/rent~w~ to purchase a room!");
						PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
						PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
		        ...
		        {
		            new tdstring[256];
    				format(tdstring, sizeof(tdstring), "Tap ~y~Enter_Key~w~ To Use Door!");
					PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
					PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
		        ...
		        for(new a = 1; a < MAX_DOORS; a++)
		        {
		            if(IsPlayerInRangeOfPoint(i, 1.0, DoorData[a][Door_Outside_X], DoorData[a][Door_Outside_Y], DoorData[a][Door_Outside_Z]))
		            {
		                ...
		                {
			            	new tdstring[256];
						    format(tdstring, sizeof(tdstring), "(Door ID: %i)~n~%s~n~~n~Tap ~y~Enter_Key~w~ To Use Door!", DoorData[a][Door_ID], DoorData[a][Door_Description]);
							PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
							PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
						...
						{
						    new tdstring[256];
						    format(tdstring, sizeof(tdstring), "%s~n~~n~Tap ~y~Enter_Key~w~ To Use Door!", DoorData[a][Door_Description]);
							PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
							PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
					...
					if(IsPlayerInRangeOfPoint(i, 1.0, DoorData[a][Door_Inside_X], DoorData[a][Door_Inside_Y], DoorData[a][Door_Inside_Z]))
		            {
		                ...
		                {
			            	new tdstring[256];
						    format(tdstring, sizeof(tdstring), "(Door ID: %i)~n~~n~Tap ~y~Enter_Key~w~ To Use Door!", DoorData[a][Door_ID]);
							PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
							PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
		        ...
		        for(new a = 1; a < MAX_FACTIONS; a++)
		        {
                    if(FactionData[a][Faction_Icon_X] != 0 && FactionData[a][Faction_Sold] == 0)
                    {
			            if(IsPlayerInRangeOfPoint(i, 3.0, FactionData[a][Faction_Icon_X], FactionData[a][Faction_Icon_Y], FactionData[a][Faction_Icon_Z]))
			            {
			                ...
			                {
			                    new tdstring[256];
							    format(tdstring, sizeof(tdstring), "(Faction ID: %i)~n~%s~n~~y~Cost: ~w~$%i ~p~(%i Coins)~n~~n~~y~/buyfaction~w~ to buy this faction!", FactionData[a][Faction_ID], FactionData[a][Faction_Name], FactionData[a][Faction_Price_Money], FactionData[a][Faction_Price_Coins]);
								PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
								PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
			                ...
			                {
				            	new tdstring[256];
							    format(tdstring, sizeof(tdstring), "%s~n~~y~Cost: ~w~$%i ~p~(%i Coins)~n~~n~~y~/buyfaction~w~ to buy this faction!", FactionData[a][Faction_Name], FactionData[a][Faction_Price_Money], FactionData[a][Faction_Price_Coins]);
								PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
								PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
					...
					if(FactionData[a][Faction_Icon_X] != 0 && FactionData[a][Faction_Sold] == 1)
                    {
			            if(IsPlayerInRangeOfPoint(i, 3.0, FactionData[a][Faction_Icon_X], FactionData[a][Faction_Icon_Y], FactionData[a][Faction_Icon_Z]))
			            {
			                ...
			                {
			                    new tdstring[256];
			                    format(tdstring, sizeof(tdstring), "(Faction ID: %i)~n~%s~n~~n~~y~Status:~w~ Owned~n~~y~Owner:~w~ %s", FactionData[a][Faction_ID], FactionData[a][Faction_Name], FactionData[a][Faction_Owner]);
								PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
								PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
			                ...
			                {
				            	new tdstring[256];
							    format(tdstring, sizeof(tdstring), "~%s~n~~n~~y~Status:~w~ Owned~n~~y~Owner:~w~ %s",FactionData[a][Faction_Name], FactionData[a][Faction_Owner]);
								PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
								PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
		        ...
		        for(new a = 1; a < MAX_HOUSES; a++)
		        {
                    if(HouseData[a][House_Outside_X] != 0 && HouseData[a][House_Sold] == 0)
                    {
			            if(IsPlayerInRangeOfPoint(i, 3.0, HouseData[a][House_Outside_X], HouseData[a][House_Outside_Y], HouseData[a][House_Outside_Z]))
			            {
			                ...
			                {
			                    new tdstring[256];
           						format(tdstring, sizeof(tdstring), "(House ID: %i)~n~%s~n~~y~Cost: ~w~$%i ~p~(%i Coins)~w~~n~~n~(Tap ENTER_KEY to go inside!)~n~~n~~y~/buyproperty~w~ to buy this property!", HouseData[a][House_ID], HouseData[a][House_Address], HouseData[a][House_Price_Money], HouseData[a][House_Price_Coins]);
								PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
								PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
			                ...
			                {
				            	new tdstring[256];
           						format(tdstring, sizeof(tdstring), "%s~n~~y~Cost: ~w~$%i ~p~(%i Coins)~w~~n~~n~(Tap ENTER_KEY to go inside!)~n~~n~~y~/buyproperty~w~ to buy this property!", HouseData[a][House_Address], HouseData[a][House_Price_Money], HouseData[a][House_Price_Coins]);
								PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
								PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
		        ...
		        for(new a = 1; a < MAX_BUSINESSES; a++)
		        {
                    if(BusinessData[a][Business_Outside_X] != 0 && BusinessData[a][Business_Sold] == 0)
                    {
			            if(IsPlayerInRangeOfPoint(i, 3.0, BusinessData[a][Business_Outside_X], BusinessData[a][Business_Outside_Y], BusinessData[a][Business_Outside_Z]))
			            {
			                ...
			                {
			                    new tdstring[256];
							    format(tdstring, sizeof(tdstring), "(Business ID: %i)~n~%s~n~~y~Cost: ~w~$%i ~p~(%i Coins)~w~~n~~n~(Tap ENTER_KEY to go inside!)~n~~n~~y~/buybusiness~w~ to buy this business!", BusinessData[a][Business_ID], BusinessData[a][Business_Name], BusinessData[a][Business_Price_Money], BusinessData[a][Business_Price_Coins]);
								PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
								PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
			                ...
			                {
				            	new tdstring[256];
							    format(tdstring, sizeof(tdstring), "%s~n~~y~Cost: ~w~$%i ~p~(%i Coins)~w~~n~~n~(Tap ENTER_KEY to go inside!)~n~~n~~y~/4~w~ to buy this business!", BusinessData[a][Business_Name], BusinessData[a][Business_Price_Money], BusinessData[a][Business_Price_Coins]);
								PlayerTextDrawSetString(i, PlayerText:Notification_Textdraw, tdstring);
								PlayerTextDrawShow(i, PlayerText:Notification_Textdraw);
...
public LoadFaction_Results()
{
	...
	if(rows)
	{
		...
		new Float:fix = cache_get_field_content_float(0, "faction_icon_x");
        new Float:fiy = cache_get_field_content_float(0, "faction_icon_y");
        new Float:fiz = cache_get_field_content_float(0, "faction_icon_z");
        FactionData[loaded][Faction_Icon_X] = fix;
        FactionData[loaded][Faction_Icon_Y] = fiy;
        FactionData[loaded][Faction_Icon_Z] = fiz;
        
        cache_get_field_content(0, "faction_owner", FactionData[loaded][Faction_Owner], connection, 50);
        
        FactionData[loaded][Faction_Price_Money] = cache_get_field_content_int(0, "faction_price_money");
        FactionData[loaded][Faction_Price_Coins] = cache_get_field_content_int(0, "faction_price_coins");
        FactionData[loaded][Faction_Sold] = cache_get_field_content_int(0, "faction_sold");
...
public LoadHouses_Results()
{
	...
	if(rows)
	{
        ...
        HouseData[loaded][House_Preset_Type] = cache_get_field_content_int(0, "house_preset_type");
...
public LoadVehicles_Results()
{
	...
	if(rows)
	{
		...
		VehicleData[loaded][Vehicle_Type] = cache_get_field_content_int(0, "vehicle_type");
		
		cache_get_field_content(0, "vehicle_license_plate", VehicleData[loaded][Vehicle_License_Plate], connection, 50);

        if(VehicleData[loaded][Vehicle_Used] != 0 && VehicleData[loaded][Vehicle_Type] != 2)
        {
...
forward GetNextDealershipVehicleID();
public GetNextDealershipVehicleID()
{
    new query[128];
    mysql_format(connection, query, sizeof(query), "SELECT MAX(`vehicle_id`) AS max_id FROM `vehicle_information`");
    mysql_tquery(connection, query, "CollectNextDealershipVehicleID");
}

forward CollectNextDealershipVehicleID(playerid);
public CollectNextDealershipVehicleID(playerid)
{
    new rows = cache_num_rows();
    new maxID = 0;
...
public DynamicDoorEntry(playerid)
{
	if(IsPlayerConnected(playerid))
	{
	    ...
	    {
	        ApplyAnimation(playerid, "HEIST9", "Use_SwipeCard", 4.0, false, 0, 0, 0, 0);
...
CMD:admins(playerid, params[])
{
	if(IsPlayerConnected(playerid))
	{
	    if(IsPlayerLogged[playerid])
	    {
			...
			SendClientMessage(playerid, COLOR_YELLOW, "{FFFFFF}*** {F2F746}Online Admins{FFFFFF} ***");
	        ...
	        for (new i = 0; i < MAX_PLAYERS; i++)
	        {
				if(PlayerData[i][Admin_Level] > 0)
				{
					...
					{
					    case 1: { atext = "[Level 1]"; }
					    case 2: { atext = "[Level 2]"; }
					    case 3: { atext = "[Level 3]"; }
					    case 4: { atext = "[Level 4]"; }
					    case 5: { atext = "[Level 5]"; }
					    case 6: { atext = "[Level 6]"; }
					}
...
CMD:recyclecar(playerid, params[])
{
	...
	else
	{
        ...
        if(IsPlayerInRangeOfPoint(playerid, 4.0, 2187.6023,-1990.5770,13.3782))
        {
	        ...
	        new query[2000];
	        mysql_format(connection, query, sizeof(query), "UPDATE `vehicle_information` SET `vehicle_faction` = '0', `vehicle_owner` = '', `vehicle_used` = '0', `vehicle_model` = '0', `vehicle_color_1` = '0', `vehicle_color_2` = '0', `vehicle_spawn_x` = '0', `vehicle_spawn_y` = '0', `vehicle_spawn_z` = '0', `vehicle_spawn_a` = '0', `vehicle_lock` = '0', `vehicle_alarm` = '0', `vehicle_gps` = '0', `vehicle_license_plate` = '0', `vehicle_fuel` = '0', `vehicle_type` = '0' WHERE `vehicle_id` = '%i' LIMIT 1", VehicleData[vehicleid][Vehicle_ID]);
	   		mysql_tquery(connection, query);
...
CMD:sellfaction(playerid, params[])
{
	if(PlayerData[playerid][Character_Registered] != 1) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
		...
		if(ficonid != 0 && FactionData[ficonid][Faction_Owner] != PlayerData[playerid][Character_Name])
		{
  		...
  		{
		    mysql_format(connection, equery, sizeof(equery), "UPDATE `faction_information` SET `faction_owner` = '' WHERE `faction_id` = '%i' LIMIT 1", ficonid);
			mysql_tquery(connection, equery);
		...
		else
  		{
			...
			if(response == 1)
			{
			    if(PlayerData[playerid][Character_Money] < FactionData[ficonid][Faction_Price_Money]) return SendPlayerErrorMessage(playerid, " You do not have enough money in hand to purchase this faction!");
	      		...
	      		mysql_format(connection, equery, sizeof(equery), "UPDATE `faction_information` SET `faction_owner` = '%e' WHERE `faction_id` = '%i' LIMIT 1", PlayerData[playerid][Character_Name], ficonid);
				mysql_tquery(connection, equery);
...
CMD:reports(playerid, params[])
{
	if(PlayerData[playerid][Character_Registered] != 1) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
	    if(PlayerData[playerid][Admin_Level] >= 1)
		{
			...
			mysql_tquery(connection, query, "OnReportCheck");
		}
		else return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	}
	return 1;
    ...
    if(PlayerData[playerid][Admin_Level] >= 6)
	{
	    ...
	    else
	    {
			...
			else
			{
				...
				new updatequery[2000];
				mysql_format(connection, updatequery, sizeof(updatequery), "UPDATE `user_accounts` SET `admin_level` = '%i' WHERE `character_name` = '%e' LIMIT 1", PlayerData[targetid][Admin_Level], PlayerData[targetid][Character_Faction_Rank], GetName(targetid));
				mysql_tquery(connection, updatequery);
...
CMD:fsettype(playerid, params[])
{
	if(PlayerData[playerid][Admin_Level] != 6) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
		...
		{
		    if(factiontype < 1 || factiontype > 3) return SendPlayerErrorMessage(playerid, " You need to select a valid faction type ID that can be used in-game!");
		    else
		    {
