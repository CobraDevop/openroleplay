...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    switch(dialogid)
    {
		...
		case DIALOG_COMMANDS_MAIN:
		{
		    ...
		    if(response)
		    {
			    new titlestring[256], dialogstring[1500], dialogstring1[250], dialogstring2[250], dialogstring3[250], dialogstring4[250], dialogstring5[250], dialogstring6[250], dialogstring7[250];
			    switch(listitem)
			    {
					case 0:
					{
			        ...
			        case 1:
					{
					    ...
					    else if(PlayerData[playerid][Character_Faction] == 1)
					    {
					        if(PlayerData[playerid][Character_Faction_Rank] != 6)
					        {
								...
								format(dialogstring3, sizeof(dialogstring3), "\nBasic: /acceptcall | /duty | /taser | /cuff | /jail | /ticket | /drag /backup(/bu) /cancelbackup(/cbu)");
							...
							else
							{
								...
								format(dialogstring1, sizeof(dialogstring1), "General: /joinfaction | /quitfaction");
								format(dialogstring2, sizeof(dialogstring2), "\nChat: factionchat(/fchat) | /radio(/r)");
								format(dialogstring3, sizeof(dialogstring3), "\nBasic: /acceptcall | /duty | /taser | /cuff | /jail | /ticket | /drag /backup");
								format(dialogstring4, sizeof(dialogstring4), "\n\nVehicle: /placeincar(/pic) | /cleo | /mdc");
			        ...
			        case 5:
					{
					    ...
					    else if(PlayerData[playerid][Admin_Level] == 6)
					    {
							...
							format(dialogstring, sizeof(dialogstring), "%s%s%s%s%s%s%s", dialogstring1, dialogstring2, dialogstring3, dialogstring4, dialogstring5, dialogstring6, dialogstring7);
							ShowPlayerDialog(playerid, DIALOG_COMMANDS_ADMIN, DIALOG_STYLE_MSGBOX, titlestring, dialogstring, "Close", "");
					    }
					}
			    }
...
public SaveUserInformation(playerid)
{
    ...
    mysql_format(connection, playerquery, sizeof(playerquery), "UPDATE `user_accounts` SET `character_age` = '%i', `character_sex` = '%s', `character_birthplace` = '%s', `character_registered` = '%i', `character_skin_1` = '%i', `character_skin_2` = '%i', `character_skin_3` = '%i', `character_skin_logout` = '%i', `character_last_login` = '%i', `character_minutes` = '%i', `character_health` = '%f', `character_armor` = '%f', \
																`character_faction` = '%i', `character_faction_rank` = '%i', `character_faction_join_request` = '%i', `character_faction_ban` = '%i', `character_money` = '%i', `character_coins` = '%i', `character_bank_account` = '%i', `character_bank_money` = '%i', `character_bank_pin` = '%s', \
																`character_vip` = '%i', `character_pos_x` = '%f', `character_pos_y` = '%f', `character_pos_z` = '%f', `character_pos_angle` = '%f', `character_interior_id` = '%i', `character_virtual_world` = '%i', `character_house_id` = '%i', `character_total_houses` = '%i', `character_total_businesses` = '%i', \
																`character_level` = '%i', `character_level_exp` = '%i', `admin_level` = '%i', `admin_level_exp` = '%i', `admin_jail` = '%i', `admin_jail_time` = '%i', `admin_jail_reason` = '%s', \
																`weapon_slot_1` = '%i', `weapon_slot_2` = '%i', `weapon_slot_3` = '%i', `weapon_slot_4` = '%i', `weapon_slot_5` = '%i', `weapon_slot_6` = '%i', \
																`ammo_slot_1` = '%i', `ammo_slot_2` = '%i', `ammo_slot_3` = '%i', `ammo_slot_4` = '%i', `ammo_slot_5` = '%i', `ammo_slot_6` = '%i', `character_radio` = '%i', \
																`character_license_car` = '%i', `character_license_truck` = '%i',`character_license_motorcycle` = '%i',`character_license_boat` = '%i',`character_license_flying` = '%i',`character_license_firearms` = '%i', `character_has_rope` = '%i' WHERE `character_name` = '%e' "
	
					, PlayerData[playerid][Character_Age] 
				    , PlayerData[playerid][Character_Sex] 
				    , PlayerData[playerid][Character_Birthplace] 
				    , PlayerData[playerid][Character_Registered] 
				    , PlayerData[playerid][Character_Skin_1]
				    , PlayerData[playerid][Character_Skin_2]
				    , PlayerData[playerid][Character_Skin_3]
				    , PlayerData[playerid][Character_Skin_Logout]
				    ...
				    , PlayerData[playerid][Character_Faction] 
				    , PlayerData[playerid][Character_Faction_Rank] 
				    , PlayerData[playerid][Character_Faction_Join_Request] 
				    , PlayerData[playerid][Character_Faction_Ban] 
				    , PlayerData[playerid][Character_Money] 
				    , PlayerData[playerid][Character_Coins] 
				    , PlayerData[playerid][Character_Bank_Account] 
				    , PlayerData[playerid][Character_Bank_Money] 
				    , PlayerData[playerid][Character_Bank_Pin] 
				    ...
				    , PlayerData[playerid][Character_House_ID] 
					...
					, PlayerData[playerid][Character_License_Car]
					, PlayerData[playerid][Character_License_Truck]
					, PlayerData[playerid][Character_License_Motorcycle]
					, PlayerData[playerid][Character_License_Boat]
					, PlayerData[playerid][Character_License_Flying]
					, PlayerData[playerid][Character_License_Firearms]
	    ...
	    else
	    {
			...
			else
			{
				if(license == 1)
				{
				    ...
				    {
                	    new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has given you a Motorcycle License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
					...
					{
	                    new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has revoked your Motorcycle License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
				...
				else if(license == 2)
				{
				    ...
				    {
                	    new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has given you a Car License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
					...
					{
                    	new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has revoked your Car License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
				...
				else if(license == 3)
				{
	    			...
	    			{
     					new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has given you a Truck License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
	    			...
	    			{
     					new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has revoked your Truck License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
				...
				else if(license == 4)
				{
    				...
    				{
    					new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has given you a Boat License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
    				...
    				{
    					new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has revoked your Boat License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
				...
				else if(license == 5)
				{
    				PlayerData[targetid][Character_License_Flying] = status;
   					...
   					{
   						new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has given you a Flying License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
   					...
   					{
   						new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has revoked your Flying License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
				...
				else if(license == 6)
				{
   					...
   					{
   						new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has given you a Firearms License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
   					...
   					{
						new dstring[256];
						format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has revoked your Firearms License");
						SendClientMessage(targetid, COLOR_YELLOW, dstring);
    ...
    if(PlayerData[playerid][Admin_Level] >= 6)
	{
	    ...
	    else
	    {
			...
			else
			{
				...
				new dstring[256];
				format(dstring, sizeof(dstring), "[UPDATE:]{FFFFFF} An Admin has given you leadership of: %s", FactionData[factionid][Faction_Name]);
				SendClientMessage(targetid, COLOR_YELLOW, dstring);
...
CMD:vdelete(playerid, params[])
{
	if(PlayerData[playerid][Admin_Level] < 5) return SendPlayerErrorMessage(playerid, " You do not have access to this feature!");
	{
        ...
        new query[2000];
        mysql_format(connection, query, sizeof(query), "UPDATE `vehicle_information` SET `vehicle_faction` = '0', `vehicle_owner` = '', `vehicle_used` = '0', `vehicle_model` = '0', `vehicle_color_1` = '0', `vehicle_color_2` = '0', `vehicle_spawn_x` = '0', `vehicle_spawn_y` = '0', `vehicle_spawn_z` = '0', `vehicle_spawn_a` = '0', `vehicle_lock` = '0', `vehicle_alarm` = '0', `vehicle_gps` = '0', `vehicle_license_plate` = '0' WHERE `vehicle_id` = '%i' LIMIT 1", VehicleData[vehicleid][Vehicle_ID]);
   		mysql_tquery(connection, query);
