...
public OnPlayerStateChange(playerid, newstate, oldstate)
{
    ...
    if(oldstate == PLAYER_STATE_ONFOOT && newstate == PLAYER_STATE_DRIVER)
	{
	    ...
	    if(GetVehicleModel(veh) == 403 || GetVehicleModel(veh) == 406 || GetVehicleModel(veh) == 407 || GetVehicleModel(veh) == 408 || GetVehicleModel(veh) == 414 || GetVehicleModel(veh) == 433 ||
		   GetVehicleModel(veh) == 443 || GetVehicleModel(veh) == 455 || GetVehicleModel(veh) == 456 || GetVehicleModel(veh) == 514 || GetVehicleModel(veh) == 515 || GetVehicleModel(veh) == 524 ||
		   GetVehicleModel(veh) == 544 || GetVehicleModel(veh) == 578 && PlayerData[playerid][Character_License_Truck] == 0)
	    {
	        format(string, sizeof(string), "- You are attempting to operate a heavy vehicle without a truck license!");
			SendClientMessage(playerid, COLOR_YELLOW, string);
		}
		else if(GetVehicleModel(veh) == 461 || GetVehicleModel(veh) == 462 || GetVehicleModel(veh) == 463 || GetVehicleModel(veh) == 468 || GetVehicleModel(veh) == 471 || GetVehicleModel(veh) == 521 ||
		   GetVehicleModel(veh) == 522 || GetVehicleModel(veh) == 523 || GetVehicleModel(veh) == 581 && PlayerData[playerid][Character_License_Motorcycle] == 0)
	    {
	        format(string, sizeof(string), "- You are attempting to operate a motorcycle without a motorcycle license!");
			SendClientMessage(playerid, COLOR_YELLOW, string);
		}
		else if(GetVehicleModel(veh) == 593 || GetVehicleModel(veh) == 592 || GetVehicleModel(veh) == 577 || GetVehicleModel(veh) == 553 || GetVehicleModel(veh) == 520 || GetVehicleModel(veh) == 519 ||
		   GetVehicleModel(veh) == 513 || GetVehicleModel(veh) == 512 || GetVehicleModel(veh) == 511 || GetVehicleModel(veh) == 497 || GetVehicleModel(veh) == 488 || GetVehicleModel(veh) == 487 ||
		   GetVehicleModel(veh) == 476 || GetVehicleModel(veh) == 469 || GetVehicleModel(veh) == 460 || GetVehicleModel(veh) == 447 || GetVehicleModel(veh) == 425 || GetVehicleModel(veh) == 417 &&
		   PlayerData[playerid][Character_License_Flying] == 0)
	    {
        	format(string, sizeof(string), "- You are attempting to operate an air vehicle without a pilots license!");
			SendClientMessage(playerid, COLOR_YELLOW, string);
		}
	    else if(GetVehicleModel(veh) == 430 || GetVehicleModel(veh) == 446 || GetVehicleModel(veh) == 452 || GetVehicleModel(veh) == 453 || GetVehicleModel(veh) == 454 || GetVehicleModel(veh) == 472 ||
		   GetVehicleModel(veh) == 473 || GetVehicleModel(veh) == 484 || GetVehicleModel(veh) == 493 || GetVehicleModel(veh) == 595 && PlayerData[playerid][Character_License_Boat] == 0)
	    {
	        format(string, sizeof(string), "- You are attempting to operate a vessel without a boat license!");
			SendClientMessage(playerid, COLOR_YELLOW, string);
		}
		else if(GetVehicleModel(veh) != 403 || GetVehicleModel(veh) != 406 || GetVehicleModel(veh) != 407 || GetVehicleModel(veh) != 408 || GetVehicleModel(veh) != 414 || GetVehicleModel(veh) != 433 ||
  			GetVehicleModel(veh) != 443 || GetVehicleModel(veh) != 455 || GetVehicleModel(veh) != 456 || GetVehicleModel(veh) != 514 || GetVehicleModel(veh) != 515 || GetVehicleModel(veh) != 524 ||
			GetVehicleModel(veh) != 544 || GetVehicleModel(veh) != 578 || GetVehicleModel(veh) != 461 || GetVehicleModel(veh) != 462 || GetVehicleModel(veh) != 463 || GetVehicleModel(veh) != 468 ||
			GetVehicleModel(veh) != 471 || GetVehicleModel(veh) != 521 || GetVehicleModel(veh) != 522 || GetVehicleModel(veh) != 523 || GetVehicleModel(veh) != 581 || GetVehicleModel(veh) != 593 ||
			GetVehicleModel(veh) != 592 || GetVehicleModel(veh) != 577 || GetVehicleModel(veh) != 553 || GetVehicleModel(veh) != 520 || GetVehicleModel(veh) != 519 || GetVehicleModel(veh) != 513 ||
			GetVehicleModel(veh) != 512 || GetVehicleModel(veh) != 511 || GetVehicleModel(veh) != 497 || GetVehicleModel(veh) != 488 || GetVehicleModel(veh) != 487 || GetVehicleModel(veh) != 476 ||
			GetVehicleModel(veh) != 469 || GetVehicleModel(veh) != 460 || GetVehicleModel(veh) != 447 || GetVehicleModel(veh) != 425 || GetVehicleModel(veh) != 417 || GetVehicleModel(veh) != 430 ||
			GetVehicleModel(veh) != 446 || GetVehicleModel(veh) != 452 || GetVehicleModel(veh) != 453 || GetVehicleModel(veh) != 454 || GetVehicleModel(veh) != 472 || GetVehicleModel(veh) != 473 ||
			GetVehicleModel(veh) != 484 || GetVehicleModel(veh) != 493 || GetVehicleModel(veh) != 595 && PlayerData[playerid][Character_License_Car] == 0)
		{
...
stock IsLSFDVehicle(vehicleid)
{
    for(new carid = 1; carid < MAX_VEHICLES; carid++)
    {
        if(carid == VehicleData[vehicleid][Vehicle_ID] && VehicleData[vehicleid][Vehicle_Faction] == 2)
        {
            return 1;
        }
    }
...
stock IsLSMCVehicle(vehicleid)
{
    for(new carid = 1; carid < MAX_VEHICLES; carid++)
    {
        if(carid == VehicleData[vehicleid][Vehicle_ID] && VehicleData[vehicleid][Vehicle_Faction] == 3)
        {
            return 1;
        }
    }
