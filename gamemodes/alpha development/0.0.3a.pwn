...
public SaveUserInformation(playerid)
{
	...
	new cquery[2000];
    mysql_format(connection, cquery, sizeof(cquery), "UPDATE `user_accounts` SET `character_registered` = '%i', `character_age` = '%i',`character_sex` = '%s',`character_birthplace` ='%s', `character_skin` ='%i', `character_last_login` ='%i', `character_minutes` ='%i', `character_pos_x` = '%f', `character_pos_y` = '%f', `character_pos_z` = '%f', `character_pos_angle` = '%f', `character_interior_id` = '%i', `character_virtual_world` = '%i'  WHERE `character_name` = '%e' LIMIT 1", PlayerData[playerid][Character_Registered], PlayerData[playerid][Character_Age], PlayerData[playerid][Character_Sex], PlayerData[playerid][Character_Birthplace], PlayerData[playerid][Character_Skin], PlayerData[playerid][Character_Last_Login], PlayerData[playerid][Character_Minutes], PlayerData[playerid][Character_Pos_X], PlayerData[playerid][Character_Pos_Y], PlayerData[playerid][Character_Pos_Z], PlayerData[playerid][Character_Pos_Angle], PlayerData[playerid][Character_Interior_ID], PlayerData[playerid][Character_Virtual_World], PlayerData[playerid][Character_Name]);
    mysql_tquery(connection, cquery);
    
    new fquery[2000];
    mysql_format(connection, fquery, sizeof(fquery), "UPDATE `user_accounts` SET `character_house_id` = '%i', `character_faction` = '%i', `character_faction_rank` = '%i', `character_faction_join_request` = '%i' WHERE `character_name` = '%e' LIMIT 1", PlayerData[playerid][Character_House_ID], PlayerData[playerid][Character_Faction], PlayerData[playerid][Character_Faction_Rank], PlayerData[playerid][Character_Faction_Join_Request], PlayerData[playerid][Character_Name]);
    mysql_tquery(connection, fquery);
    ...
    new aquery[2000];
    mysql_format(connection, aquery, sizeof(aquery), "UPDATE `user_accounts` SET `character_level` = '%i',`character_level_exp` = '%i', `admin_level` = '%i',`admin_level_exp` = '%i' WHERE `character_name` = '%e' LIMIT 1",PlayerData[playerid][Character_Level], PlayerData[playerid][Character_Level_Exp],PlayerData[playerid][Admin_Level], PlayerData[playerid][Admin_Level_Exp], PlayerData[playerid][Character_Name]);
...
public LoginSpawn(playerid)
{
    ...
    {
        if(PlayerData[playerid][Character_House_ID] != 0)
	    {
		...
		else
		{
	    	...
	    	SetPlayerPos(playerid, HouseData[houseid][House_Inside_X], HouseData[houseid][House_Inside_Y], HouseData[houseid][House_Inside_Z]);
			SetPlayerFacingAngle(playerid, HouseData[houseid][House_Inside_A]);

			SetPlayerInterior(playerid, HouseData[houseid][House_Inside_Interior]);
			SetPlayerVirtualWorld(playerid, HouseData[houseid][House_Inside_VW]);
		}
